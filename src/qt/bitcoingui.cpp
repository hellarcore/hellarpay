...
#include "config/hellar-config.h"
#endif
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Hellar address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hellar: URIs)"));
    ...
    goodsAction = new QAction(QIcon(":/icons/" + theme + "/shopping_cart"), tr("&Goods&&&Services"), this);
    goodsAction->setStatusTip(tr("Show links to services that accept hellars"));
    ...
    aboutAction->setStatusTip(tr("Show information about Hellar Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Hellar addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Hellar addresses"));
    ...
    genAndPrintAddressesAction = new QAction(QIcon(":/icons/cash_icon"), tr("&Print hellars..."), this);
    ...
    loadFromPaperAction = new QAction(QIcon(":/icons/import"), tr("&Load hellars..."), this);
    loadFromPaperAction->setIconVisibleInMenu(true);
    loadFromPaperAction->setStatusTip(tr("Load hellars from paper"));
    
    openAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_DirOpenIcon), tr("Open &URI..."), this);
    openAction->setStatusTip(tr("Open a hellar: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Hellar command-line options").arg(tr(PACKAGE_NAME)));

    showPrivateSendHelpAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&PrivateSend information"), this);
    showPrivateSendHelpAction->setMenuRole(QAction::NoRole);
    showPrivateSendHelpAction->setStatusTip(tr("Show the PrivateSend basic information"));

    showHelpHellarAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Howto"), this);
    showHelpHellarAction->setStatusTip(tr("How to use Hellars"));
    ...
    connect(showHelpHellarAction, SIGNAL(triggered()), this, SLOT(showHelpHellarClicked()));
#ifdef ENABLE_WALLET
    if(walletFrame)
    {
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(showHelpHellarAction);
...
#ifdef ENABLE_WALLET
void BitcoinGUI::setHelModel(HelModel *helModel)
{
...
bool BitcoinGUI::addWallet(const QString& name, WalletModel *walletModel)
{
    ...
    walletFrame->setHelModel(helModel);
...
void BitcoinGUI::showHelpHellarClicked()
{
    HelpHellarDialog *help = new HelpHellarDialog(this);
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Hellar network", "", count));
    } else {
...
{
    QString strTitle = tr("Hellar Core"); // default title
