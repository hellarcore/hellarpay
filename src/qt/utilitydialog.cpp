    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  hellar-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Hellar in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.1 HEL, 1 HEL, 10 HEL and 100 HEL -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"http://hellar.io/privatesend\">http://hellar.io/privatesend</a>"
        ));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
...
HelpHellarDialog::HelpHellarDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::HelpMessageDialog)
{
    ui->setupUi(this);
    ...
    QString res_name = ":/html/hellardesc";
    QString htmlContent;
...
HelpHellarDialog::~HelpHellarDialog()
{
    GUIUtil::saveWindowGeometry("nHelpMessageDialogWindow", this);
    delete ui;
}

void HelpHellarDialog::printToConsole()
{
    // On other operating systems, the expected action is to print the message to the console.
...
void HelpHellarDialog::showOrPrint()
{
#if defined(WIN32)
        // On Windows, show a message box, as there is no stderr/stdout in windowed applications
        exec();
...
void HelpHellarDialog::on_okButton_accepted()
{
    close();
}
