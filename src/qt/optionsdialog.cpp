    ...
    mapper(0)
{
    ...
    /* Theme selector */
//    ui->theme->addItem(QString("HEL-light-hires"), QVariant("light-hires"));
//    ui->theme->addItem(QString("HEL-light-retro"), QVariant("light-retro"));
//    ui->theme->addItem(QString("HEL-light-hires-retro"), QVariant("light-hires-retro"));
//    ui->theme->addItem(QString("HEL-blue"), QVariant("drkblue"));
//    ui->theme->addItem(QString("HEL-Crownium"), QVariant("crownium"));
