...
enum WalletFeature
{
    ...
    FEATURE_HD = 160300,    // Hierarchical key derivation after BIP32 (HD Wallet), BIP44 (multi-coin), BIP39 (mnemonic)
...
enum AvailableCoinsType
{
    ...
    ONLY_DENOMINATED,
    ONLY_NONDENOMINATED,
    ONLY_MNCOLLATERAL, // find masternode outputs including locked ones (use with caution)
...
public:
    ...
    /// Get 1000HEL output and keys which can be used for the Masternode
