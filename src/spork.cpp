...
std::map<int, int64_t> mapSporkDefaults = {
    ...
    {SPORK_5_INSTANTSEND_MAX_VALUE,          1000},          // 1000 HEL
    ...
    {SPORK_10_MASTERNODE_PAY_UPDATED_NODES,  0}, // OFF
    {SPORK_12_RECONSIDER_BLOCKS,             0},             // 0 BLOCKS
    {SPORK_14_REQUIRE_SENTINEL_FLAG,         4070908800ULL}, // OFF
    {SPORK_15_REJECT_OLD_BLOCKS,             4070908800ULL}, // OFF
...
{
    if(fLiteMode) return; // disable all Hellar specific functionality
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_15_REJECT_OLD_BLOCKS:                return "SPORK_15_REJECT_OLD_BLOCKS";
