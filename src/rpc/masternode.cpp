...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Hellar address\n"
            "  payee          - Print the masternode payout Hellar address (can be additionally filtered,\n"
            "                   partial match)\n"
            ...
            "  votingaddress  - Print the masternode voting Hellar address\n"
        );
}
...
UniValue masternode_outputs(const JSONRPCRequest& request)
{
    ...
    pwalletMain->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_MNCOLLATERAL);
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "hellar",               "masternode",             &masternode,             true,  {} },
    { "hellar",               "masternodelist",         &masternodelist,         true,  {} },
    { "hellar",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "hellar",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "hellar",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "hellar",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
