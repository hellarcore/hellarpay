...
{
    std::string strSecret = std::string("5HvectGeVXNx3Q4yq66zvYHFVc3NcuJkfbpceiUT2eAJQM7HNXp");
    ...
    std::vector<unsigned char> vch = ParseHex("03f368b5080000000000000001");
    std::vector<char> expected(vch.size());
...
BOOST_AUTO_TEST_CASE(rolling_bloom)
{
    ...
    // Run test_hellar with --log_level=message to see BOOST_TEST_MESSAGEs:
