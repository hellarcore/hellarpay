...
#define BOOST_TEST_MODULE Hellar Test Suite

#include "test_hellar.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_hellar_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
