...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 HEL from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 HEL in block rewards plus fees, but
        ...
        fee_per_byte = Decimal('0.0001') / 1000
        ...
        # Send 100 HEL with subtract fee from amount
        ...
        # Sendmany 100 HEL with subtract fee from amount
