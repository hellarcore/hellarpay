...
This mechanism has been integrated into Bitcore-Node-Hellar which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Hellarpay/insight-api-hellar#web-socket-api](https://github.com/Hellarpay/insight-api-hellar#web-socket-api)
* API: [https://github.com/Hellarpay/insight-api-hellar#instantsend-transactions](https://github.com/Hellarpay/insight-api-hellar#instantsend-transactions)
